...
0
        ...
        .then(response => {
            if (response.ok) {
                response.json().then(data => {
                    ...
                    document.getElementById("update_licence_no").value = existingData.license_no;
                    document.getElementById("update_points").value = existingData.review_points;
                });
            } else if (response.status === 401) {
                console.log('Unauthorized');
            } else {
    ...
    document.getElementById("busUpdateForm").addEventListener("submit", function(event) {
        ...
        const license_no = document.getElementById("update_licence_no").value;
        const review_points = document.getElementById("update_points").value;
    ...
    const form = `
        <div class="driver_form_left">
            <div class="form_div">
                ...
                <input type="text" name="driver_id" id="driver_id" class="form_data" placeholder="update the Driver ID"  />
            </div>
            <div class="form_div">
                <label for="licence_no" class="driver_form_title">Driving License Number <span class="driver_form_require">*</span></label>
                <input type="text" name="licence_no" id="licence_no" class="form_data" placeholder=" update driving License Number"  />
            </div>
            <div class="form_div">
