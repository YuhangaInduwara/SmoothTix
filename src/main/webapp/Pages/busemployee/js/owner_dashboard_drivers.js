...
<
            ...
            <td>
                ...
                <span class="icon-container" style="margin-left: 1px;">
                    <i onclick="deleteRow('${item.driver_id}')"><img src="../../../images/vector_icons/delete_icon.png" alt="delete" class="action_icon"></i>
                </span>
            </td>
        `;
...
function createForm() {
    ...
    var form= `
        <div class="driver_form_left">
            ...
            <div class="form_div">
                <label for="passenger_id" class="driver_form_title">Passenger ID <span class="driver_form_require">*</span></label>
            ...
            <div class="form_div">
                <label for="name" class="driver_form_title">Name <span class="driver_form_require">*</span></label>
                <input type="text" name="name" id="name" class="form_data" placeholder="Enter name" required="required" />
            </div>
        </div>
        <div class="driver_form_right">
            <div class="form_div">
            ...
            <div class="form_div">
                <label for="mobile" class="driver_form_title">Mobile number <span class="driver_form_require">*</span></label>
                <input type="text" name="mobile" id="mobile" class="form_data" placeholder="Enter mobile number" required="required" />
            </div>
            <div class="form_div">
                <label for="email" class="driver_form_title">Email <span class="driver_form_require">*</span></label>
                <input type="text" name="email" id="email" class="form_data" placeholder="Enter email" required="required" />
            </div>
            <div class="form_div">
                <label for="points" class="driver_form_title">Points <span class="driver_form_require">*</span></label>
