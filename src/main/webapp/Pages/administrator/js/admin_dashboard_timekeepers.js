...
function createForm() {
    ...
    var form= `
        <div class="bus_form_left">
            <div class="form_div">
                <label for="owner_nic" class="bus_form_title">NIC<span class="bus_form_require">*</span></label>
                <input type="text" name="owner_nic" id="owner_nic" class="form_data" placeholder="Enter NIC" required="required" />
            </div>
        </div>
        `;
