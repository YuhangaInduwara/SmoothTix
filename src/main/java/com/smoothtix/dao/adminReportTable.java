...
public class adminReportTable {
    public static AdminReport generateReport(String startDate, String endDate, String routeNo) throws SQLException {
        ...
        return new AdminReport(startDate + " to " + endDate, routeNo, totalSeatsBooked, totalBusesScheduled, commission,TotalAmount);
